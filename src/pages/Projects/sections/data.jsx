    ...
    // luna
    {
      ...
      modal: {
        ...
        description: [
          ...
          "brand showcase with company info, services, and organized presentation sections.",
        ],
  ...
  [
    // e-store
    {
      ...
      modal: {
        ...
        description: [
          "an e-commerce website that utilizes APIs to fetch products.",
          "Users can create accounts, allowing them to maintain their personal wishlists and cart items.",
          "the website features a user-friendly dashboard where users can manage their products, including adding, updating and deleting them as needed.",
        ],
